...
<div class="header"><h1>🛡️ CrowdStrike IaC Security Assessment</h1>
...
<div class="footer"><strong>🛡️ CrowdStrike Falcon Cloud Security</strong></div>
</div></body></html>"""
    return html
...
<div class="header"><h1>🛡️ CrowdStrike Container Image Assessment</h1>
