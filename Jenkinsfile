...
def main():
    ...
    # Default input and output files (Jenkins workspace paths)
    input_file = '/workspace/iac_scan_results.json'
    output_file = '/workspace/iac_assessment_report.html'
...
'''
                        ...
                        // Debug: Verify scan results file exists and show details
                        sh '''
                            echo "=== Debug: Verifying scan results file ==="
                            ...
                            if [ -f "$WORKSPACE/iac_scan_results.json" ]; then
                                ...
                                head -10 "$WORKSPACE/iac_scan_results.json"
                                echo ""
                            else
                                echo "❌ ERROR: iac_scan_results.json not found!"
                                exit 1
                            fi
                        '''
