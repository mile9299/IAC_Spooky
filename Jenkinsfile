...
def generate_iac_report():
    ...
    if os.path.exists(report_path):
        ...
        try:
            ...
            # If local file shows summary but no detailed findings, use API
            if len(findings) == 0 and ("total" in scan_data or "summary" in scan_data):
                print(f"Local file has summary but no detailed findings")
        except Exception as e:
